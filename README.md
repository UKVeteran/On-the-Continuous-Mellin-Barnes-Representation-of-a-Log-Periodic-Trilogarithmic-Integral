...
$$J = \text{Re} \left\{ \Gamma\left(2 + \frac{i\pi}{\log 2}\right) \sum_{n=1}^{\infty} \frac{\dot{Z}_{1/2}\left(2 + \frac{i\pi}{\log 2}, \sqrt{2}n + \frac{1}{2}\right) - \dot{Z}_{1/2 - \sqrt{3}n}\left(2 + \frac{i\pi}{\log 2}, \frac{1}{2}\right)}{n^3} \right\}$$
...
$$I_2(k_2) = \int_{0}^{1} x^{-1/2} (1-x)^{k_2\sqrt{3} - 1/2} \log x \log(1-x) \cos\left( \omega \log(-\log x) \right) dx$$
...
$$I_2(k_2) = \text{Re} \left[ \frac{\partial^2}{\partial \alpha \partial \beta} \text{B}\left(\alpha + i\omega, \beta\right) \right]_{\alpha = 1/2,\,\, \beta = k_2\sqrt{3} + 1/2}$$
